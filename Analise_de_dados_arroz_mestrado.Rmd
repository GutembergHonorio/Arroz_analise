...
---
Para acessar o script desta analise acesse [repositório github](<https://github.com/GutembergHonorio/Arroz_Mestrado.git>)
...
# Distribuição geografica dos ensáios
  
Mapa do Brasil com as distribuições geográficas dos ensáios
```{r Mapa com as distribuição dos ensáios, include=FALSE}
