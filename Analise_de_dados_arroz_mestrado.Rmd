...
Temporario<- TabelabrutaIRR %>% mutate( TMedia = ((Tmax_Media+Tmin_Media)/2)) %>% group_by(TMedia) %>% summarise(FLO = mean(FLO)) %>% na.omit(Temporario)

 ggplot(Temporario)+
  geom_point(aes(x=TMedia,y=FLO),Temporario, color= "blue")+
  geom_smooth(aes(x=TMedia,y=FLO), se= T, method='lm', color = "black")+
  labs(x="Temperatura média (ºC)", y="Data de florecimento (DAE)" , title ="Relação temperatura média e data de florecimento de arroz irrigados")+
  theme(plot.title = element_text(hjust = 0.5))
...
Temporario<- TabelabrutaIRR %>% group_by(FLO) %>% summarise(Tmax = mean(Tmax_Media), Tmin = mean(Tmin_Media)) %>% na.omit(Temporario)

ggplot(Temporario)+
  geom_point(aes(x=Tmax,y=FLO),Temporario, color= "blue")+
  geom_point(aes(x=Tmin,y=FLO),Temporario, color= "blue")+ 
  #geom_smooth(aes(x=TMedia,y=FLO), se= T, color = "black")+
  labs(x="Temperatura (ºC)", y="Data de florecimento (DAE)" , title ="Relação temperatura máxima e minima e data de florecimento de arroz irrigados")+
  theme(plot.title = element_text(hjust = 0.5))
```
...
Temporario<- Temporario2 %>% filter(Clima=="subtropical") %>%  mutate( TMedia = ((Tmax_Media+Tmin_Media)/2)) %>% group_by(TMedia,Clima) %>% summarise(FLO = mean(FLO)) %>% na.omit(Temporario)


 ggplot(Temporario)+
  geom_point(aes(x=TMedia,y=FLO),Temporario, color= "blue")+
  geom_smooth(aes(x=TMedia,y=FLO), se= T, method='lm', color = "black")+
  labs(x="Temperatura média (ºC)", y="Data de florecimento (DAE)" , title ="Relação temperatura média e data de florecimento de arroz irrigados subtropical")+
  theme(plot.title = element_text(hjust = 0.5))
```
```{r , echo=FALSE}
...
Temporario<- Temporario2 %>% filter(Clima=="tropical") %>%  mutate( TMedia = ((Tmax_Media+Tmin_Media)/2)) %>% group_by(TMedia,Clima) %>% summarise(FLO = mean(FLO)) %>% na.omit(Temporario)


 ggplot(Temporario)+
  geom_point(aes(x=TMedia,y=FLO),Temporario, color= "blue")+
  geom_smooth(aes(x=TMedia,y=FLO), se= T, method='lm', color = "black")+
  labs(x="Temperatura média (ºC)", y="Data de florecimento (DAE)" , title ="Relação temperatura média e data de florecimento de arroz irrigados tropical")+
  theme(plot.title = element_text(hjust = 0.5))
```
```{r , echo=FALSE}
...
# Determinação do graus-dia para o ciclo
