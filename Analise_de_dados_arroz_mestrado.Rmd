...
```{r Boxplots, echo=FALSE, warning=FALSE, fig.align='center', out.width='55%'}
...
ggplot(Temporario) +
  geom_line(aes(y=CICLO, x= latitude))+
  labs(y="Ciclo total da cultura (DAE)", x= "Latitude", color = "Legenda", title ="Variação da temperatura média minima, média e média maxima pela Latitude")+
  theme_classic()
```
...
Temporario2<- TabelabrutaIRR %>% mutate( Clima= case_when(UF == "RS" ~ "subtropical", UF != "RS" ~ "tropical"))
