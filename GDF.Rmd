...
```
 ...
 Para o arroz de terras altas em região subtropical, a soma termica necessária para o florecimento que mais se repete é `r a` ºC.
...
```
 ...
 Para o arroz de terras altas em regição tropical, a soma termica necessários para que as plantas completem o ciclo que mais se repete é `r a` ºC. .
